...
export var Input = function (props) {
    var _a;
    // 去除各种的属性
    var disabled = props.disabled, size = props.size, prepend = props.prepend, append = props.append, style = props.style, icon = props.icon, restProps = __rest(props
    // 根据属性计算不同的className 
    , ["disabled", "size", "prepend", "append", "style", "icon"]);
    // 根据属性计算不同的className 
